...
import { SignalDesk, type SignalPage } from "@/components/SignalDesk";
    ...
    <div className="atlas-product-shell">
      <div className="atlas-view-toggle" role="tablist" aria-label="Product view">
          ...
          {signalMenuOpen ? (
            <div className="atlas-signal-menu" id="signal-page-menu" role="menu" aria-label="Signal pages">
              {([
                ...
                <button key={page} type="button" role="menuitem" className={signalPage === page ? "atlas-menu-active" : ""} onClick={() => selectSignalPage(page)}>
                  {label}
                </button>
              ))}
            </div>
        ...
        <button
          ...
          onClick={() => { setView("map"); setSignalMenuOpen(false); }}
        >
