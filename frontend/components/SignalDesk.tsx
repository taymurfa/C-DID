...
export const SIGNAL_PAGES: { page: SignalPage; label: string }[] = [
  ...
  { page: "connections", label: "People" },
  { page: "companies", label: "Companies" },
  { page: "sequences", label: "Sequences" },
  { page: "funnel", label: "Funnel" },
    ...
    <main className="app-shell">
      <section className="workspace" aria-label="Signal Desk workspace">
        <header className="workspace-header">
          ...
          {activePage === "funnel" ? <span className="header-count"><Target size={16} />{data.meetingsBooked} meetings</span> : null}
        ...
        {activePage === "connections" ? <ConnectionsPage speakers={data.filteredLeads} selected={data.selected} selectedId={data.selectedId} statuses={data.statuses} onSelect={data.setSelectedId} onAdvance={data.advanceStatus} onOpenSpeaker={openSpeaker} onOpenSequences={() => navigate("sequences")} /> : null}
        {activePage === "companies" ? <CompaniesView /> : null}
        {activePage === "sequences" ? <SequencesView /> : null}
        {activePage === "funnel" ? <FunnelView /> : null}
